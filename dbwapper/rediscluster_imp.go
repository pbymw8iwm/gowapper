...
func (r *RedisClusterClient) Connect(param *RedisCacheParam) error {
	r.RedisClient = redis.NewClusterClient(&redis.ClusterOptions{
		Addrs:    param.Server_addrs,
...
func (client *RedisClusterClient) Publish(channel string, message interface{}) int64 {
